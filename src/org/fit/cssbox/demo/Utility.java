...
public class Utility {
    ...
    public static boolean shouldVisit(String url, Set<String> visited) {
        url = url.toLowerCase();
        if ((url.contains(".edu") || url.contains(".ca")) && url.startsWith("http")&& !url.endsWith("#")&& !FILTERS.matcher(url).matches() &&
    ...
    public static boolean negative(String text,String url) {
        ...
        if (!text.matches("\\D*") || text.toUpperCase().contains("PROGRAM") || text.toUpperCase().contains("DEPARTMENT") || text.toUpperCase().contains("OFFICE") || text.toUpperCase().contains("CENTER") || text.toUpperCase().contains("MAJOR") || text.toUpperCase().contains("MINOR") || text.toUpperCase().contains("CATALOG") || text.toUpperCase().contains("ONLINE")
